...
export const MA_ITEMS = [
  ...
  // ============================ MA A4 — presenting management information (MA-09) ============================
  {
    id: 'MA-09-CC1', conceptIds: ['MA-09'], rung: 'concept-check', marks: 1,
    stem: 'To show a trend in sales over twelve months, the best display is:',
    options: [
      { id: 'a', text: 'A line chart' },
      { id: 'b', text: 'A pie chart' },
      { id: 'c', text: 'A single number' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'A line chart shows a trend over time.',
  },
  {
    id: 'MA-09-CC2', conceptIds: ['MA-09'], rung: 'concept-check', marks: 1,
    stem: 'To show each product’s share of total sales, the best display is:',
    options: [
      { id: 'a', text: 'A pie chart' },
      { id: 'b', text: 'A line chart' },
      { id: 'c', text: 'A scatter diagram' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'A pie chart shows parts of a whole (proportions).',
  },
  {
    id: 'MA-09-CC3', conceptIds: ['MA-09'], rung: 'concept-check', marks: 1,
    stem: 'The format of management reports follows:',
    options: [
      { id: 'a', text: 'No prescribed external format — it is tailored to the decision' },
      { id: 'b', text: 'A fixed format set by IFRS' },
      { id: 'c', text: 'Rules set by the tax authority' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Management information has no external rulebook; it is shaped to the decision.',
  },
  {
    id: 'MA-09-G1', conceptIds: ['MA-09'], rung: 'guided', marks: 1,
    stem: 'To compare sales across five regions at a single date, the best display is:',
    options: [
      { id: 'a', text: 'A bar chart' },
      { id: 'b', text: 'A line chart' },
      { id: 'c', text: 'A pie chart of one region' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    scaffold: ['Comparing categories at a point → bars.', 'Line is for trends over time; pie is for shares.'],
    rationale: 'A bar chart compares categories at a point in time.',
  },
  {
    id: 'MA-09-G2', conceptIds: ['MA-09'], rung: 'guided', marks: 1,
    stem: 'The format of a piece of management information should be chosen to:',
    options: [
      { id: 'a', text: 'Fit the decision being made and the reader receiving it' },
      { id: 'b', text: 'Look as detailed as possible regardless of the reader' },
      { id: 'c', text: 'Match the statutory accounts exactly' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    scaffold: ['Ask: who reads it, and what are they deciding?', 'The format serves that decision and reader.'],
    rationale: 'Format is chosen for the decision and the reader.',
  },
  {
    id: 'MA-09-G3', conceptIds: ['MA-09'], rung: 'guided', marks: 1,
    stem: 'A scatter diagram is used to show:',
    options: [
      { id: 'a', text: 'The relationship between two variables' },
      { id: 'b', text: 'Each part’s share of a whole' },
      { id: 'c', text: 'A single total figure' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    scaffold: ['Scatter plots pairs of values.', 'It reveals how one variable moves with another.'],
    rationale: 'A scatter diagram shows the relationship between two variables.',
  },
  {
    id: 'MA-09-S1', conceptIds: ['MA-09'], rung: 'standard', marks: 1,
    stem: 'A manager must read off precise figures and add several of them. Which presentation suits this best?',
    options: [
      { id: 'a', text: 'A table' },
      { id: 'b', text: 'A pie chart' },
    ...
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Tables give exact values you can read and total; charts trade precision for a visual pattern.',
  },
  {
    id: 'MA-09-S2', conceptIds: ['MA-09'], rung: 'standard', marks: 1,
    stem: 'Which is a feature of GOOD management information?',
    options: [
      { id: 'a', text: 'Relevant, clear, concise and timely, sent to the right person' },
      { id: 'b', text: 'As long and detailed as possible, sent to everyone' },
      { id: 'c', text: 'Always audited before use' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'Good information is relevant, clear, concise, timely and correctly directed.',
  },
  {
    id: 'MA-09-S3', conceptIds: ['MA-09'], rung: 'standard', marks: 1,
    stem: 'Why can management reports differ in format from one company to another?',
    options: [
      { id: 'a', text: 'There is no external rulebook — each report is tailored to its decision' },
      { id: 'b', text: 'Because IFRS lets companies choose between two fixed formats' },
      { id: 'c', text: 'Because the tax authority sets a different format each year' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'Management reporting is internal and unregulated in format — tailored to the decision.',
  },
  {
    id: 'MA-09-ST1', conceptIds: ['MA-09'], rung: 'stretch', marks: 2,
    stem: 'A manager wants to see whether total cost rises as output rises. Using only this topic, which display serves this and why?',
    options: [
      { id: 'a', text: 'A scatter diagram — it plots cost against output to reveal the relationship between the two' },
      { id: 'b', text: 'A pie chart — it shows cost as a share of output' },
      { id: 'c', text: 'A single table cell — the relationship is one number' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'transfer_failure' },
    rationale: 'A relationship between two variables (cost vs output) is exactly what a scatter diagram shows.',
  },

  // ============================ MA B1 — sampling methods (MA-10) ============================
  {
    id: 'MA-10-CC1', conceptIds: ['MA-10'], rung: 'concept-check', marks: 1,
    stem: 'In RANDOM sampling, each item in the population has:',
    options: [
      { id: 'a', text: 'An equal chance of being selected' },
      { id: 'b', text: 'A chance based on the interviewer’s choice' },
      { id: 'c', text: 'No chance unless it is the tenth item' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Random sampling gives every item an equal chance of selection.',
  },
  {
    id: 'MA-10-CC2', conceptIds: ['MA-10'], rung: 'concept-check', marks: 1,
    stem: 'Selecting every 10th invoice from a numbered list is:',
    options: [
    ...
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Taking every nth item is systematic sampling.',
  },
  {
    id: 'MA-10-CC3', conceptIds: ['MA-10'], rung: 'concept-check', marks: 1,
    stem: 'Dividing staff into grades and sampling each grade in proportion to its size is:',
    options: [
      { id: 'a', text: 'Stratified sampling' },
      { id: 'b', text: 'Cluster sampling' },
      { id: 'c', text: 'Random sampling' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Sampling proportionally within groups (strata) is stratified sampling.',
  },
  {
    id: 'MA-10-G1', conceptIds: ['MA-10'], rung: 'guided', marks: 1,
    stem: 'Which method requires a complete list of the population (a sampling frame)?',
    options: [
      { id: 'a', text: 'Random sampling' },
      { id: 'b', text: 'Quota sampling' },
      { id: 'c', text: 'Judgement sampling' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    scaffold: ['To give everyone an equal chance you must be able to list everyone.', 'That list is the sampling frame.'],
    rationale: 'Random selection needs a complete sampling frame; quota and judgement do not.',
  },
  {
    id: 'MA-10-G2', conceptIds: ['MA-10'], rung: 'guided', marks: 1,
    stem: 'Quota sampling is best described as:',
    options: [
      { id: 'a', text: 'Non-random — interviewers fill set quotas by category' },
      { id: 'b', text: 'Random — every item has an equal chance' },
      { id: 'c', text: 'Taking every nth item from a list' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    scaffold: ['Quota = fill targets by category.', 'No sampling frame, no equal chance → non-random.'],
    rationale: 'Quota sampling is non-random and prone to interviewer bias.',
  },
  {
    id: 'MA-10-G3', conceptIds: ['MA-10'], rung: 'guided', marks: 1,
    stem: 'Cluster sampling means:',
    options: [
      { id: 'a', text: 'Selecting whole groups (clusters) and examining the items within them' },
      { id: 'b', text: 'Selecting one item at random from the whole list' },
      { id: 'c', text: 'Filling quotas by category' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    scaffold: ['Cluster = whole groups, often by geography.', 'You then examine everything inside the chosen groups.'],
    rationale: 'Cluster sampling selects whole groups rather than individuals.',
  },
  {
    id: 'MA-10-S1', conceptIds: ['MA-10'], rung: 'standard', marks: 1,
    stem: 'Systematic sampling can be BIASED when:',
    options: [
      { id: 'a', text: 'The list has a repeating pattern that matches the selection interval' },
      { id: 'b', text: 'The population is very large' },
      { id: 'c', text: 'A complete sampling frame exists' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'If the interval aligns with a cycle in the data, systematic sampling keeps hitting the same kind of item.',
  },
  {
    id: 'MA-10-S2', conceptIds: ['MA-10'], rung: 'standard', marks: 1,
    stem: 'Which method is NON-random and therefore most prone to interviewer bias?',
    options: [
      { id: 'a', text: 'Quota sampling' },
      { id: 'b', text: 'Random sampling' },
      { id: 'c', text: 'Stratified sampling' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Quota sampling is non-random — the interviewer chooses who fills the quota, risking bias.',
  },
  {
    id: 'MA-10-S3', conceptIds: ['MA-10'], rung: 'standard', marks: 1,
    stem: 'A firm wants each region represented in proportion to its number of customers. Which method fits?',
    options: [
      { id: 'a', text: 'Stratified sampling' },
    ...
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Proportional representation of subgroups is exactly stratified sampling.',
  },
  {
    id: 'MA-10-ST1', conceptIds: ['MA-10'], rung: 'stretch', marks: 2,
    stem: 'An analyst samples every 7th daily sales record. Using only this topic, why might this mislead?',
    options: [
      { id: 'a', text: 'A 7-day interval can always land on the same weekday, so a weekly pattern biases the sample (periodic bias in systematic sampling)' },
      { id: 'b', text: 'Systematic sampling is random, so it can never be biased' },
      { id: 'c', text: 'Every 7th item guarantees a stratified, proportional sample' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
