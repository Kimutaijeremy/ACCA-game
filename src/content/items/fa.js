...
export const FA_ITEMS = [
  ...
  // ============================ FA A2 — users and their information needs (FA-03) ============================
  {
    id: 'FA-03-CC1', conceptIds: ['FA-03'], rung: 'concept-check', marks: 1,
    stem: 'Which of these is an EXTERNAL user of financial statements?',
    options: [
      { id: 'a', text: 'A bank considering a loan' },
      { id: 'b', text: 'The production manager' },
      { id: 'c', text: 'The board of directors' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'A lender is external; managers and directors are internal users.',
  },
  {
    id: 'FA-03-CC2', conceptIds: ['FA-03'], rung: 'concept-check', marks: 1,
    stem: 'A lender reads the financial statements mainly to judge:',
    options: [
      { id: 'a', text: 'Whether the business can repay its debts' },
      { id: 'b', text: 'The marketing strategy' },
      { id: 'c', text: 'Staff morale' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'Lenders focus on repayment — liquidity and gearing.',
  },
  {
    id: 'FA-03-CC3', conceptIds: ['FA-03'], rung: 'concept-check', marks: 1,
    stem: 'Which user is primarily interested in job security and pay?',
    options: [
      { id: 'a', text: 'Employees' },
      { id: 'b', text: 'Suppliers' },
      { id: 'c', text: 'The tax authority' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Employees read the accounts for security and pay prospects.',
  },
  {
    id: 'FA-03-G1', conceptIds: ['FA-03'], rung: 'guided', marks: 1,
    stem: 'A supplier deciding whether to sell goods on credit most wants to know:',
    options: [
      { id: 'a', text: 'Whether it will be paid — the business’s short-term liquidity' },
      { id: 'b', text: 'The long-term dividend policy' },
      { id: 'c', text: 'The number of employees' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    scaffold: ['A supplier’s risk is not being paid.', 'That points to short-term liquidity.'],
    rationale: 'Suppliers (trade payables) care most about being paid — liquidity.',
  },
  {
    id: 'FA-03-G2', conceptIds: ['FA-03'], rung: 'guided', marks: 1,
    stem: 'Why does a potential shareholder read the financial statements?',
    options: [
      { id: 'a', text: 'To weigh the return and risk of buying, holding or selling shares' },
      { id: 'b', text: 'To set the corporation tax rate' },
      { id: 'c', text: 'To audit the company' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    scaffold: ['An investor is making a buy/hold/sell decision.', 'That decision weighs return against risk.'],
    rationale: 'Investors decide buy/hold/sell on the basis of return and risk.',
  },
  {
    id: 'FA-03-G3', conceptIds: ['FA-03'], rung: 'guided', marks: 1,
    stem: 'Which pair are BOTH external users?',
    options: [
      { id: 'a', text: 'A bank and the tax authority' },
      { id: 'b', text: 'A manager and the tax authority' },
      { id: 'c', text: 'An employee and the board' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    scaffold: ['Internal = managers, directors, employees.', 'External = investors, lenders, suppliers, customers, government, public.'],
    rationale: 'Banks and the tax authority are both external; managers, employees and the board are internal.',
  },
  {
    id: 'FA-03-S1', conceptIds: ['FA-03'], rung: 'standard', marks: 1,
    stem: 'Which statement about users is correct?',
    options: [
      { id: 'a', text: 'Different users need different information from the same statements' },
      { id: 'b', text: 'All users need exactly the same information' },
      { id: 'c', text: 'Only the owners are users of the statements' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'The same statements serve many users, each with a different decision.',
  },
  {
    id: 'FA-03-S2', conceptIds: ['FA-03'], rung: 'standard', marks: 1,
    stem: 'The government / tax authority uses the financial statements mainly to:',
    options: [
      { id: 'a', text: 'Assess tax and gather economic statistics' },
      { id: 'b', text: 'Decide the dividend' },
      { id: 'c', text: 'Set the company’s selling prices' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'Government uses them for tax assessment, regulation and statistics.',
  },
  {
    id: 'FA-03-S3', conceptIds: ['FA-03'], rung: 'standard', marks: 1,
    stem: 'Which correctly splits internal from external users?',
    options: [
      { id: 'a', text: 'Internal: managers and employees. External: investors, lenders, suppliers, government.' },
      { id: 'b', text: 'Internal: lenders and suppliers. External: managers and employees.' },
      { id: 'c', text: 'Internal: the tax authority. External: the board of directors.' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'conceptual_misunderstanding' },
    rationale: 'Managers and employees are internal; everyone else listed is external.',
  },
  {
    id: 'FA-03-ST1', conceptIds: ['FA-03'], rung: 'stretch', marks: 2,
    stem: 'A customer is about to sign a three-year supply contract. Using only this topic, what do they most want from the accounts, and why?',
    options: [
      { id: 'a', text: 'Evidence the business will survive to honour the contract — its going concern and financial strength' },
      { id: 'b', text: 'The directors’ individual salaries, to negotiate a discount' },
      { id: 'c', text: 'The dividend history, because customers are paid dividends' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'transfer_failure' },
    rationale: 'A customer relying on future supply cares that the business will still be there — survival/going concern.',
  },

  // ============================ FA A4 — regulatory framework & standard setting (FA-06) ============================
  {
    id: 'FA-06-CC1', conceptIds: ['FA-06'], rung: 'concept-check', marks: 1,
    stem: 'Which body actually SETS IFRS Accounting Standards?',
    options: [
      { id: 'a', text: 'The International Accounting Standards Board (IASB)' },
      { id: 'b', text: 'The IFRS Foundation' },
      { id: 'c', text: 'The national tax authority' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'The IASB sets the standards; the IFRS Foundation oversees the process.',
  },
  {
    id: 'FA-06-CC2', conceptIds: ['FA-06'], rung: 'concept-check', marks: 1,
    stem: 'The Conceptual Framework is best described as:',
    options: [
      { id: 'a', text: 'The reasoning that underpins the standards — not itself a standard' },
      { id: 'b', text: 'An IFRS Accounting Standard like any other' },
      { id: 'c', text: 'A tax statute' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'The Framework defines elements and recognition and underpins standards, but is not a standard.',
  },
  {
    id: 'FA-06-CC3', conceptIds: ['FA-06'], rung: 'concept-check', marks: 1,
    stem: 'The main purpose of a financial-reporting regulatory framework is to:',
    options: [
      { id: 'a', text: 'Make statements comparable and reliable for users' },
      { id: 'b', text: 'Maximise the tax collected' },
      { id: 'c', text: 'Fix the prices companies charge' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'Regulation exists to make accounts comparable and reliable, protecting users.',
  },
  {
    id: 'FA-06-G1', conceptIds: ['FA-06'], rung: 'guided', marks: 1,
    stem: 'In the due process, which step is published for public comment just before the final standard?',
    options: [
      { id: 'a', text: 'The exposure draft' },
      { id: 'b', text: 'The final standard itself' },
      { id: 'c', text: 'The annual report' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    scaffold: ['Order: discussion paper → exposure draft → final standard.', 'The consultation step is the exposure draft.'],
    rationale: 'The exposure draft is the proposed standard issued for public comment.',
  },
  {
    id: 'FA-06-G2', conceptIds: ['FA-06'], rung: 'guided', marks: 1,
    stem: 'What is the role of the IFRS Foundation?',
    options: [
      { id: 'a', text: 'Oversight and governance of the standard-setting structure' },
      { id: 'b', text: 'Writing each individual accounting standard' },
      { id: 'c', text: 'Auditing listed companies' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    scaffold: ['Separate "oversees" from "writes".', 'The Foundation governs; the IASB writes.'],
    rationale: 'The IFRS Foundation provides oversight and governance; the IASB writes standards.',
  },
  {
    id: 'FA-06-G3', conceptIds: ['FA-06'], rung: 'guided', marks: 1,
    stem: 'When every company applies the same standards, which quality most improves for users?',
    options: [
      { id: 'a', text: 'Comparability' },
      { id: 'b', text: 'Secrecy' },
      { id: 'c', text: 'Tax revenue' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    scaffold: ['Ask what a shared rulebook lets a user do across companies.', 'It lets them compare like with like.'],
    rationale: 'A common rulebook makes statements comparable across companies and countries.',
  },
  {
    id: 'FA-06-S1', conceptIds: ['FA-06'], rung: 'standard', marks: 1,
    stem: 'An exposure draft is:',
    options: [
      { id: 'a', text: 'A proposed standard issued for public comment before it is finalised' },
      { id: 'b', text: 'A standard that is already mandatory' },
      { id: 'c', text: 'A summary of a company’s results' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'An exposure draft is the consultation stage — a proposed standard out for comment.',
  },
  {
    id: 'FA-06-S2', conceptIds: ['FA-06'], rung: 'standard', marks: 1,
    stem: 'Which statement is correct?',
    options: [
      { id: 'a', text: 'The IASB sets standards; the Conceptual Framework guides but is not itself a standard' },
      { id: 'b', text: 'The Conceptual Framework overrides individual standards' },
      { id: 'c', text: 'The IFRS Foundation writes each standard and the IASB audits them' },
    ],
    answerId: 'a',
    distractors: { b: 'incorrect_treatment', c: 'conceptual_misunderstanding' },
    rationale: 'IASB sets standards; the Framework underpins them; the Foundation oversees.',
  },
  {
    id: 'FA-06-S3', conceptIds: ['FA-06'], rung: 'standard', marks: 1,
    stem: 'Why is a single set of global standards valuable to an investor comparing companies in different countries?',
    options: [
      { id: 'a', text: 'The accounts are prepared on the same basis, so they can be compared like with like' },
      { id: 'b', text: 'It guarantees every company makes a profit' },
      { id: 'c', text: 'It removes the need for an audit' },
    ],
    answerId: 'a',
    distractors: { b: 'conceptual_misunderstanding', c: 'knowledge_gap' },
    rationale: 'Common standards give comparability across borders.',
  },
  {
    id: 'FA-06-ST1', conceptIds: ['FA-06'], rung: 'stretch', marks: 2,
    stem: 'A new type of transaction arises for which no specific IFRS exists. Using only this topic, what guides the accounting treatment, and why?',
    options: [
      { id: 'a', text: 'The Conceptual Framework — its definitions and recognition criteria for the elements — because it underpins the standards where none is specific' },
      { id: 'b', text: 'Whatever minimises the tax bill that year' },
      { id: 'c', text: 'Nothing — the transaction cannot be recorded until a standard is written' },
    ],
    answerId: 'a',
    distractors: { b: 'incorrect_treatment', c: 'conceptual_misunderstanding' },
